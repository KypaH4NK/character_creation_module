...
def special(char_name: str, char_class: str) -> str:
    """Cоотношения char_class -> special skill.
    в зависимости от char_class -> +stats.
    """
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """Соотношение char_class -> message.
    Соотношение cmd -> action.
    """
    if char_class == 'warrior':
